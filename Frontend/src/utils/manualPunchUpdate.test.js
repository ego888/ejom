...
test("earlier manual OUT becomes IN while the original assumed IN becomes OUT", () => {
  const entry = { id: 1, date: "2026-08-29", timeIn: "13:25", timeOut: null, time: "13:25", origTimeOut: null };
  ...
  assert.equal(payload.time, undefined);
  assert.equal(payload.origTimeOut, undefined);

    ...
    const handleDetailInputChange = (uniqueId, field, value) => {
        setEditedValues(prev => {
            ...
            if (['width', 'height', 'unit', 'quantity'].includes(field)) {
                ...
                console.log('Updated values:', updatedValues[uniqueId]);
            }
                                        ...
                                        <tr key={uniqueId}>
                                            {editingRowId === uniqueId ? (
                                                <>
                                                    ...
                                                    <td style={{ width: '60px' }}>
                                                        <input 
                                                            ...
                                                            value={editedValues[uniqueId]?.quantity || detail.quantity}
                                                            onChange={(e) => handleDetailInputChange(uniqueId, 'quantity', e.target.value)}
                                                        />
                                                    </td>
                                                    <td>
                                                        <input 
                                                    ...
                                                    <td>
                                                        <select 
                                                            className={`form-select form-select-sm unit-select ${editErrors[uniqueId]?.unit ? 'is-invalid' : ''}`}
                                                    ...
                                                    <td>
                                                        <select 
                                                            className={`form-select form-select-sm material-select ${editErrors[uniqueId]?.material ? 'is-invalid' : ''}`}
                                                    ...
                                                    <td>
                                                        <input 
                                                            ...
                                                            value={editedValues[uniqueId]?.perSqFt || detail.perSqFt}
                                                            onChange={(e) => handleDetailInputChange(uniqueId, 'perSqFt', e.target.value)}
                                                        />
                                                    </td>
                                                    <td>
                                                        <input 
                                                            ...
                                                            value={editedValues[uniqueId]?.unitPrice || detail.unitPrice}
                                                            onChange={(e) => handleDetailInputChange(uniqueId, 'unitPrice', e.target.value)}
                                                        />
                                                    </td>
                                                    <td>
                                                        <input 
                                                            ...
                                                            value={editedValues[uniqueId]?.discount || detail.discount}
                                                            onChange={(e) => handleDetailInputChange(uniqueId, 'discount', e.target.value)}
                                                        />
                                                    </td>
                                                    ...
                                                    <td>
                                                        <input 
                                                            ...
                                                            onChange={(e) => handleDetailInputChange(uniqueId, 'itemDescription', e.target.value)}
                                                        />
                                                    </td>
                                                    <td>
                                                        <input 
                                                            ...
                                                            onChange={(e) => handleDetailInputChange(uniqueId, 'remarks', e.target.value)}
                                                        />
                                                    </td>
                                                    <td>
                                                ...
                                                <>
                                                    ...
                                                    <td className="centered-cell">{detail.quantity}</td>
                            ...
                            <div className="modal-footer">
                                ...
                                <button 
                                    ...
                                    onClick={() => {
                                        ...
                                        // Prepare the updated detail by merging current detail with new allowance values
                                        const updatedDetail = {
                                            ...currentDetail,  // Keep all existing detail data
                                        ...
                                        console.log('Saving detail with allowance:', updatedDetail);

...
const AddMaterial = () => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:3000/auth/add_material', formData)
            .then(result => {
            ...
            <div className='p-3 rounded w-50 border'>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className='d-flex gap-3'>
                        <button type='button' className='btn btn-warning w-100' onClick={() => navigate('/dashboard/material')}>Cancel</button>
